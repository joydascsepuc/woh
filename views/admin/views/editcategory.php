...
<div class="col-md-10 justify-content-center">
	...
	<div style="padding: 30px !important;">
		<form action="controllers/category/update.php" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col">
					<div class="form-group">
					    <label for="title">Name</label>
					    <input type="text" name="name" value="<?=$cate['name']; ?>" class="form-control" id="title" placeholder="Title of Category" required>
					</div>
				</div>
